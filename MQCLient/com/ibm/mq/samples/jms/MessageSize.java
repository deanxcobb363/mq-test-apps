...
public class MessageSize {
	...
	private static final String QUEUE_NAME = "DEV.QUEUE.5"; // Queue that the application uses to put and get messages to and from
...
// consider loop here
      for (int i = 0; i < 100; i++) {
			...
			TextMessage message = context.createTextMessage("\n Woops Too Large : " + uniqueNumber);
			System.out.println("\n  Sent Message larger than message size: " + uniqueNumber);


			producer = context.createProducer();
			producer.send(destination, message);
//			System.out.println("Sent message:\n" + message);
			System.out.println("\n  Message Sent to Queue with Unique Number: " + uniqueNumber);
    	recordSuccess();
    }
// consider loop end here
